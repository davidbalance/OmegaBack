...
const TABLE_NAME: string = 'tbl_lab_exam_subtype_external_key';
...
export class CreateLaboratoryExamSubtypeExternalKeyTable1721691027373 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'exam_subtype_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
