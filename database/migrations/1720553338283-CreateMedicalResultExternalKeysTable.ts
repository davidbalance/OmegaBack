...
const TABLE_NAME: string = 'tbl_m_result_external_key';
...
export class CreateMedicalResultExternalKeysTable1720553338283 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'result_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
