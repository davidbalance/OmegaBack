...
const TABLE_NAME: string = 'tbl_lo_branch_external_key';
...
export class CreateLocationBranchExternalKeysTable1720540463072 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'branch_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
