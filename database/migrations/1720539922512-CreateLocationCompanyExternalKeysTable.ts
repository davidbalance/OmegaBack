...
const TABLE_NAME: string = 'tbl_lo_company_external_key';
...
export class CreateLocationCompanyExternalKeysTable1720539922512 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'company_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
