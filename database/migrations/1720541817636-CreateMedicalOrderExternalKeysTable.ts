...
const TABLE_NAME: string = 'tbl_m_order_external_key';
...
export class CreateMedicalOrderExternalKeysTable1720541817636 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'order_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
