...
const TABLE_NAME: string = 'tbl_lab_exam_external_key';
...
export class CreateLabExamExternalKeyTable1720538797652 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'exam_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
