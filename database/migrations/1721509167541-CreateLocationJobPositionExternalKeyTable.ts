...
const TABLE_NAME: string = 'tbl_lo_job_position_external_key';
...
export class CreateLocationJobPositionExternalKeyTable1721509167541 implements MigrationInterface {
        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'job_position_external_key_id', type: 'int', isPrimary: true, isGenerated: true, generationStrategy: 'increment' },
                ]
            }),
            true,
        );
