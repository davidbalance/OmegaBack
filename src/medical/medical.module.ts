...
import { ClientReadController } from "./controller/read/client-read.controller";
import { ClientWriteController } from "./controller/write/client-write.controller";
import { OrderProcessReadController } from "./controller/read/order-process-read.controller";
import { OrderReadController } from "./controller/read/order-read.controller";
import { OrderYearReadController } from "./controller/read/order-year-read.controller";
import { OrderWriteController } from "./controller/write/order-write.controller";
import { TestReadController } from "./controller/read/test-read.controller";
import { TestFindOneQueryProvider } from "./nest/query/test/test-find-one.query";
import { TestEditExamCommandProvider } from "./nest/command/test/test-edit-exam.nest-command";
import { OrderCreatedStatusCommandProvider } from "./nest/command/order/order-created-status.nest-command";
import { OrderValidatedStatusCommandProvider } from "./nest/command/order/order-validated-status.nest-command";
...
import { TestGetZipQueryProvider } from "./nest/query/test/test-get-zip.nest-query";
import { FileReadController } from "./controller/read/file-read.controller";
import { LocalZipModule } from "@local-zip/local-zip";
import { TestCheckFileCommandProvider } from "./nest/command/test/test-check-file.nest-command";
import { TestFileResultReportQueryProvider } from "./nest/query/test/test-file-result-report.nest-query";
import { TestFileResultCountQueryProvider } from "./nest/query/test/test-file-result-count.nest-query";
import { ClientAddRecordCommandProvider } from "./nest/command/client/client-add-record.nest-command";
import { ClientRecordFindOneFileQueryProvider } from "./nest/query/client/client-record-find-one-file.nest-query";
import { ClientHelperModule } from "@omega/adapter/helpers/medical/client/client-helper.module";
import { RecordReadController } from "./controller/read/record-read.controller";
...
import { ClientUpdateRecordCommandProvider } from "./nest/command/client/client-update-record-metadata.nest-command";
import { PuppeteerPdfModule } from "@pdf/puppeteer-pdf";
import { ClientCompleteRecordCommandProvider } from "./nest/command/client/client-complete-record.nest-command";
import { ClientRecordFindOneMetadataQueryProvider } from "./nest/query/client/client-record-find-one-metadata.nest-query";
...
@Module({
    ...
    providers: [
        ...
        ClientUpdateRecordCommandProvider,
        ClientCompleteRecordCommandProvider,
        ClientCreateManyCommandProvider,
        ClientRecordFindOneFileQueryProvider,
        ClientRecordFindOneMetadataQueryProvider,
