...
import { ResultRemoveFileCommand, ResultRemoveFileCommandPayload } from "../result-remove-file.command";
...
describe("ResultRemoveFileCommand", () => {
    ...
    beforeEach(() => {
        ...
        handler = new ResultRemoveFileCommand(file, repository, filepathRepository);
    });
