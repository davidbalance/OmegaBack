...
import { DiseaseReportRemoveCommand, DiseaseReportRemoveCommandPayload } from "../disease-report-remove.command";
...
describe("DiseaseReportRemoveCommand", () => {
    ...
    beforeEach(() => {
        ...
        handler = new DiseaseReportRemoveCommand(repository);
    });
