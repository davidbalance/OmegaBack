...
describe("OrderSendMailCommand", () => {
    ...
    let layout: jest.MockedFunction<HtmlLoaderProvider<{ orderId: string, patientFullname: string }>>;
    ...
    beforeEach(() => {
        ...
        handler = new OrderSendMailCommand(repository, emailEmitter, layout, attachment);
    });
