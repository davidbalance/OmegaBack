...
import { OrderFindManyQuery, OrderFindManyQueryImpl, OrderFindManyQueryPayload } from "../order.find-many.query";
...
describe("OrderFindManyQuery", () => {
    ...
    beforeEach(() => {
        ...
        queryHandler = new OrderFindManyQueryImpl(repository);
    });
