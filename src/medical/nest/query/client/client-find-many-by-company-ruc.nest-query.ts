...
import { ClientFindManyByCompanyRucQuery } from "@omega/medical/application/queries/client/client-find-many-by-company-ruc.query";
import { ClientRepository } from "@omega/medical/application/repository/model.repositories";

@Injectable()
class ClientFindManyByCompanyRucNestQuery extends ClientFindManyByCompanyRucQuery {
    constructor(
