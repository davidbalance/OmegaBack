...
import { ClientManagementFindOneQueryImpl } from "@omega/medical/application/queries/client/client-management-find-one.query";
...
@Injectable()
class ClientManagementFindOneNestQuery extends ClientManagementFindOneQueryImpl {
    constructor(
