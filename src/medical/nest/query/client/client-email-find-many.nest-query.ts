...
import { ClientEmailFindManyQueryImpl } from "@omega/medical/application/queries/client/client-email-find-many.query";
...
@Injectable()
class ClientEmailFindManyNestQuery extends ClientEmailFindManyQueryImpl {
    constructor(
