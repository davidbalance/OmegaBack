...
import { OrderPatientFindManyQueryImpl } from "@omega/medical/application/queries/order/order-patient.find-many.query";
...
@Injectable()
class OrderPatientFindManyNestQuery extends OrderPatientFindManyQueryImpl {
    constructor(
