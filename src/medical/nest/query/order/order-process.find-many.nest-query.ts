...
import { OrderProcessFindManyQueryImpl } from "@omega/medical/application/queries/order/order-process.find-many.query";
...
@Injectable()
class OrderProcessFindManyNestQuery extends OrderProcessFindManyQueryImpl {
    constructor(
