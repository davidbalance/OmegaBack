...
import { TestFindManyByExternalKeyQueryImpl } from "@omega/medical/application/queries/test/test-find-many-by-external-key.query";
import { TestFindManyQuery } from "@omega/medical/application/queries/test/test-find-many.query";

@Injectable()
class TestFindManyByExternalKeyNestQuery extends TestFindManyByExternalKeyQueryImpl {
    constructor(
