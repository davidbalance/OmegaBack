...
import { ReportGetFileQuery, ReportLayoutFunc } from "@omega/medical/application/queries/test/report-get-file.query";
import { ReportLayoutToken } from "../../inject/function.inject";

@Injectable()
class ReportGetFileNestQuery extends ReportGetFileQuery {
    constructor(
