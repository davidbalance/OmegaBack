...
import { ClientAddRecordCommandImpl, ClientRecordFilenameFunc, ClientRecordLayoutFunc } from "@omega/medical/application/commands/client/client-add-record.command";
