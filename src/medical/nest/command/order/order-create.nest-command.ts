...
import { OrderCreateCommandImpl } from "@omega/medical/application/commands/order/order-create.command";
...
@Injectable()
class OrderCreateNestCommand extends OrderCreateCommandImpl {
    constructor(
