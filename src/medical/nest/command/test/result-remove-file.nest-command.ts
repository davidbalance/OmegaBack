...
import { ResultRemoveFileCommandImpl } from "@omega/medical/application/commands/test/result-remove-file.command";
...
@Injectable()
class ResultRemoveFileNestCommand extends ResultRemoveFileCommandImpl {
    constructor(
