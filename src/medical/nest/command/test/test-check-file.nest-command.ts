...
import { TestCheckFileCommandImpl } from "@omega/medical/application/commands/test/test-check-file.command";
...
@Injectable()
class TestCheckFileNestCommand extends TestCheckFileCommandImpl {
    constructor(
