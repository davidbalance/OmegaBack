...
import { ReportUploadBufferCommandImpl } from "@omega/medical/application/commands/test/report-upload-buffer.command";
...
@Injectable()
class ReportUploadBufferNestCommand extends ReportUploadBufferCommandImpl {
    constructor(
