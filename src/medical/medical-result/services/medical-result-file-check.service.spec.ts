...
describe('MedicalResultFileCheckService', () => {
    ...
    describe('generateReport', () => {
        ...
        it('should throw not found exception', async () => {
            ...
            const spyRetriveMedicalResults = jest.spyOn(service as any, 'retriveMedicalResults').mockResolvedValue([]);
    ...
    describe('retriveResultFiles', () => {
        ...
        it('should retrive data', async () => {
            // Arrange
            // Act
            await (service as any).retriveResultFiles();
    ...
    describe('retriveMedicalResults', () => {
        ...
        it('should retrive data', async () => {
            // Arrange
            // Act
            await (service as any).retriveMedicalResults();
