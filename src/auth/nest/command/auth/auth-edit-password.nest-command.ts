...
import { AuthEditPasswordCommand } from "@omega/auth/application/command/auth/auth-edit-password.command";
...
@Injectable()
class AuthEditPasswordNestCommand extends AuthEditPasswordCommand {
    constructor(
