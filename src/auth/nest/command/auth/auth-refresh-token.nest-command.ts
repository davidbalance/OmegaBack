...
import { AuthRefreshTokenCommand } from "@omega/auth/application/command/auth/auth-refresh-token.command";
...
@Injectable()
class AuthRefreshTokenNestCommand extends AuthRefreshTokenCommand {
    constructor(
