...
import { AuthRemoveTokenCommand } from "@omega/auth/application/command/auth/auth-remove-token.command";
...
@Injectable()
class AuthRemoveTokenNestCommand extends AuthRemoveTokenCommand {
    constructor(
