...
import { ApiKeyFindManyQueryImpl } from "@omega/auth/application/query/auth/api-key-find-many.query";
import { InjectJwt } from "@shared/shared/nest/inject";
import { JwtProvider } from "@shared/shared/providers/jwt.provider";

@Injectable()
class ApiKeyFindManyNestQuery extends ApiKeyFindManyQueryImpl {
    constructor(
