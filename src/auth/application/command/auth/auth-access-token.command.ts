...
export interface AuthAccessTokenCommand extends CommandHandlerAsync<AuthAccessTokenCommandPayload, { accessToken: string, refreshToken: string }> { }

export class AuthAccessTokenCommandImpl implements AuthAccessTokenCommand {
    constructor(
