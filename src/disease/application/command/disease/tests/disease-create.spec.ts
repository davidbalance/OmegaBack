...
import { DiseaseCreateCommand, DiseaseCreateCommandImpl, DiseaseCreateCommandPayload } from "../disease-create.command";
...
describe("DiseaseCreateCommand", () => {
    ...
    beforeEach(() => {
        ...
        command = new DiseaseCreateCommandImpl(repository);
    });
