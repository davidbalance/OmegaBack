...
export interface UserFindOneQuery extends QueryHandlerAsync<UserFindOneQueryPayload, UserModel> { }

export class UserFindOneQueryImpl implements UserFindOneQuery {
    constructor(
