...
import { ExamTypeRemoveCommand } from "@omega/laboratory/application/command/exam/exam-type-remove.command";
...
@Injectable()
class ExamTypeRemoveNestCommand extends ExamTypeRemoveCommand {
    constructor(
