...
import { ExamTypeEditCommand } from "@omega/laboratory/application/command/exam/exam-type-edit.command";
...
@Injectable()
class ExamTypeEditNestCommand extends ExamTypeEditCommand {
    constructor(
