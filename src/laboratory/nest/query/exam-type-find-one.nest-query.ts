...
import { ExamTypeFindOneQueryImpl } from "@omega/laboratory/application/query/exam/exam-type-find-one.query";
...
@Injectable()
class ExamTypeFindOneNestQuery extends ExamTypeFindOneQueryImpl {
    constructor(
