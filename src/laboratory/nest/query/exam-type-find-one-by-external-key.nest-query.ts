...
import { ExamTypeFindOneByExternalKeyQueryImpl } from "@omega/laboratory/application/query/exam/exam-type-find-one-by-external-key.query";
import { ExamTypeFindOneQuery } from "@omega/laboratory/application/query/exam/exam-type-find-one.query";

@Injectable()
class ExamTypeFindOneByExternalKeyNestQuery extends ExamTypeFindOneByExternalKeyQueryImpl {
    constructor(
