...
import { ExamReadController } from "./controller/read/exam-read.controller";
import { ExamSubtypeReadController } from "./controller/read/exam-subtype-read.controller";
import { ExamTypeReadController } from "./controller/read/exam-type-read.controller";
import { ExamWriteController } from "./controller/write/exam-write.controller";
import { ExamSubtypeWriteController } from "./controller/write/exam-subtype-write.controller";
import { ExamSubtypeMoveCommandProvider } from "./nest/command/exam-subtype-move.nest-command";
import { ExamMoveCommandProvider } from "./nest/command/exam-move.nest-command";
