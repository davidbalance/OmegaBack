...
import { CompanyRemoveCommand, CompanyRemoveCommandImpl, CompanyRemoveCommandPayload } from "../company-remove.command";
...
describe("CompanyRemoveCommand", () => {
    ...
    beforeEach(() => {
        ...
        command = new CompanyRemoveCommandImpl(repository);
    });
