...
import { CorporativeFindOptionsQueryImpl } from "@omega/location/application/query/corporative/corporative-find-options.query";
...
@Injectable()
class CorporativeFindOptionsNestQuery extends CorporativeFindOptionsQueryImpl {
    constructor(
