...
import { BranchCreateFromExternalSourceCommandImpl } from "@omega/location/application/command/corporative/branch-create-from-external-source.command";
...
@Injectable()
class BranchCreateFromExternalSourceNestCommand extends BranchCreateFromExternalSourceCommandImpl {
    constructor(
