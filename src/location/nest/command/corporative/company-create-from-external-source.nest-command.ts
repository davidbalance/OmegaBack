...
import { CompanyCreateFromExternalSourceCommandImpl } from "@omega/location/application/command/corporative/company-create-from-external-source.command";
...
@Injectable()
class CompanyCreateFromExternalSourceNestCommand extends CompanyCreateFromExternalSourceCommandImpl {
    constructor(
