...
export const mockExtendedCorporativeGroup = () => stubExternalCorporativeGroup(1);
export const mockExtendedCorporativeGroups = () => Array(20).map(stubExternalCorporativeGroup);